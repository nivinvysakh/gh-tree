...
export const PRESETS: TreePreset[] = [
  ...
  },
  {
    ...
    name: "Crimson Nether",
    emoji: "🔥",
    description: "Nether crimson hyphae stem, radiant flame wart canopy, and campfire embers.",
    options: {
      treeType: "crimson",
      pet: "fox",
      showCampfire: true,
  ...
  },
  {
    ...
    name: "Warped Aurora",
    emoji: "🌊",
    description: "Warped teal forest, glowing bioluminescent spores, and tamed cat companion.",
    options: {
      treeType: "warped",
      pet: "cat",
      showCampfire: false,
